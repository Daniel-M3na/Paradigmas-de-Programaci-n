...
def calcularpi_kernel(rng_states, iteraciones, out_d):
    """Encontrar el valo máximo en value y guardarlo eb result[0]"""
    ii = cuda.grid(1)

    # Calcular pi dibujando puntos (x,y) al azar encontrando
    # la función de ellos que cae dentro del círculo unitario
    cae_dentro = 0
